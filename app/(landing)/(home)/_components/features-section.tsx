  ...
  const features = [
    {
      ...
      title: "Fast Delivery",
      description:
        "Same-day and express delivery options available nationwide.",
      color: "blue",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-3">
            Why Choose Our{" "}
            <span className="text-primary">Genz Deliver Service</span>?
          </h2>
          <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Reliable, fast, and secure parcel delivery with features designed
            for seamless shipping experience.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  className={`flex h-12 w-12 items-center justify-center rounded-xl ${feature.iconBg} group-hover:scale-110 transition-transform duration-300 flex-shrink-0`}
                >
